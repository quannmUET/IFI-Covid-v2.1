...
class ViewPatientDetailModal extends React.Component {
    constructor(props) {
        ...
        console.log(this.state.patient.vaccinationInfo);
    }
                            ...
                            <Col xs={9}>
                                <fieldset disabled>
                                    ...
                                    <Form.Group as={Row} controlId="form-group-id" className="mb-1">
                                        <Form.Label size="sm" column xs={4}>Patient ID:</Form.Label>
                                        <Col xs={8}>
                                    ...
                                    {/* Patient Name */}
                                    <Form.Group as={Row} controlId="form-group-id" className="mb-1">
                                        <Form.Label size="sm" column xs={4}>Patient Name:</Form.Label>
                                        <Col xs={8}>
                                    ...
                                    {/* Patient Gender */}
                                    <Form.Group as={Row} controlId="form-group-id" className="mb-1">
                                        <Form.Label size="sm" column xs={4}>Gender:</Form.Label>
                                        <Col xs={8}>
                                    ...
                                    {/* Patient Birthday */}
                                    <Form.Group as={Row} controlId="form-group-id" className="mb-1">
                                        <Form.Label size="sm" column xs={4}>Date Of Birth:</Form.Label>
                                        <Col xs={8}>
                                    ...
                                    {/* Patient ID Card */}
                                    <Form.Group as={Row} controlId="form-group-id" className="mb-1">
                                        <Form.Label size="sm" column xs={4}>ID Card:</Form.Label>
                                        <Col xs={8}>
                                    ...
                                    {/* Patient Insurance */}
                                    <Form.Group as={Row} controlId="form-group-id" className="mb-1">
                                        <Form.Label size="sm" column xs={4}>Insurance Number:</Form.Label>
                                        <Col xs={8}>
                                    ...
                                    {/* Patient Address */}
                                    <Form.Group as={Row} controlId="form-group-id" className="mb-1">
                                        <Form.Label size="sm" column xs={4}>Address:</Form.Label>
                                        <Col xs={8}>
                                            <Form.Control readOnly type="text" size="sm" defaultValue={this.state.patient.address.street + ", " + this.state.patient.address.ward + ", " + this.state.patient.address.district + ", " + this.state.patient.address.city} />
                                        </Col>
                                    </Form.Group>
                                    {/* Patient Phone */}
                                    <Form.Group as={Row} controlId="form-group-id" className="mb-1">
                                        <Form.Label size="sm" column xs={4}>Phone Number:</Form.Label>
                                        <Col xs={8}>
                                    ...
                                    <Row>
                                        ...
                                        <Col xs={6}>
                                            ...
                                            <Form.Group as={Row} controlId="no1VaccineName" className="mb-1">
                                                ...
                                                <Col xs={6}>
                                                    <Form.Control readOnly type="text" size="sm" defaultValue={(!this.state.patient.vaccinationInfo.length) ? "" : this.state.patient.vaccinationInfo[0].vaccineName} />
                                                </Col>
                                            </Form.Group>
                                            {/* No.1 Vaccine No */}
                                            <Form.Group as={Row} controlId="no1VaccineNo" className="mb-1">
                                                ...
                                                <Col xs={6}>
                                                    <Form.Control readOnly type="text" size="sm" defaultValue={(!this.state.patient.vaccinationInfo.length) ? "" : this.state.patient.vaccinationInfo[0].vaccineNo} />
                                                </Col>
                                            </Form.Group>
                                            {/* No.1 Injection Date */}
                                            <Form.Group as={Row} controlId="no1InjectionDate" className="mb-1">
                                                ...
                                                <Col xs={6}>
                                                    <Form.Control readOnly type="text" size="sm" defaultValue={(!this.state.patient.vaccinationInfo.length) ? "" : this.state.patient.vaccinationInfo[0].injectionDate} />
                                                </Col>
                                            </Form.Group>
                                            ...
                                            <Form.Group as={Row} controlId="no1InjectionPlace" className="mb-1">
                                                ...
                                                <Col xs={6}>
                                                    <Form.Control readOnly type="text" size="sm" defaultValue={(!this.state.patient.vaccinationInfo.length) ? "" : this.state.patient.vaccinationInfo[0].injectionPlace} />
                                                </Col>
                                            </Form.Group>
                                        </Col>
                                        {/* Injection no.2 */}
                                        <Col xs={6}>
                                            ...
                                            <Form.Group as={Row} controlId="no2VaccineName" className="mb-1">
                                                <Form.Label size="sm" column xs={6} >Vaccine Name:</Form.Label>
                                                <Col xs={6}>
                                                    <Form.Control readOnly type="text" size="sm" defaultValue={(this.state.patient.vaccinationInfo.length <= 1) ? "" : this.state.patient.vaccinationInfo[0].vaccineName} />
                                                </Col>
                                            </Form.Group>
                                            {/* no.2 Vaccine No */}
                                            <Form.Group as={Row} controlId="no2VaccineNo" className="mb-1">
                                                <Form.Label size="sm" column xs={6} >Vaccine No:</Form.Label>
                                                <Col xs={6}>
                                                    <Form.Control readOnly type="text" size="sm" defaultValue={(this.state.patient.vaccinationInfo.length <= 1) ? "" : this.state.patient.vaccinationInfo[0].vaccineNo} />
                                                </Col>
                                            </Form.Group>
                                            {/* no.2 Injection Date */}
                                            <Form.Group as={Row} controlId="no2InjectionDate" className="mb-1">
                                                <Form.Label size="sm" column xs={6} >Injection Date:</Form.Label>
                                                <Col xs={6}>
                                                    <Form.Control readOnly type="text" size="sm" defaultValue={(this.state.patient.vaccinationInfo.length <= 1) ? "" : this.state.patient.vaccinationInfo[0].injectionDate} />
                                                </Col>
                                            </Form.Group>
                                            ...
                                            <Form.Group as={Row} controlId="no2InjectionPlace" className="mb-1">
                                                <Form.Label size="sm" column xs={6} >Injection Place:</Form.Label>
                                                <Col xs={6}>
                                                    <Form.Control readOnly type="text" size="sm" defaultValue={(this.state.patient.vaccinationInfo.length <= 1) ? "" : this.state.patient.vaccinationInfo[0].injectionPlace} />
                                                </Col>
                                            </Form.Group>
                                        </Col>
